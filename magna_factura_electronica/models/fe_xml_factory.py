    ...
    def get_data_XML(self):
        ...
        if self.opt._referenciaIndicadorGlobal > 0:
            ...
            if self.opt._referenciaMntCFEref:
                ...
                self._set_fe_node_data(doc, SubZonaReferencia, 'FEREFMntCFE',
                                       str(self.opt._referenciaMntCFEref))
                self._set_fe_node_data(doc, SubZonaReferencia, 'FEREFTpoMoneda',
                                       str(self.opt._referenciaTpoMonedaRef))
                self._set_fe_node_data(doc, SubZonaReferencia, 'FEREFTpoCambio',
